...
//const cartoDBClient = new CartoDBClientLib(config.userId, { apiroot: 'https://' + config.userId + '.cartodb.com/api/v2/' });
cartoDBClient.apiroot = 'https://' + config.userId + '.cartodb.com/api/v2/';
